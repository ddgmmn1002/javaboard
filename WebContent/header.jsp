								...
								<li class="nav-item dropdown">
									<button class="btn btn-lg nav-link dropdown-toggle text-light" role="button"
										...
										<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
											fill="currentColor" class="bi bi-person-vcard-fill me-1" viewBox="0 0 16 16">
											<path
							...
							<core:otherwise>
								<li class="nav-item">
									<a href="signUpForm.jsp" class="nav-link text-light">
										<div class="d-flex align-items-center gap-1">
											<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
												fill="currentColor" class="bi bi-person-plus-fill me-1" viewBox="0 0 16 16">
												<path
								...
								<li class="nav-item">
									<a href="#" class="nav-link text-light" data-bs-toggle="modal"
										...
										<div class="d-flex align-items-center gap-1">
											<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
												fill="currentColor" class="bi bi-person-check-fill me-1" viewBox="0 0 16 16">
												<path fill-rule="evenodd"
						...
						<core:if test="${not empty userInfo }">
							<core:if test="${userInfo.getGrade() eq 'admin' }">
								<li class="nav-item dropdown">
									<button class="btn btn-lg nav-link dropdown-toggle text-light" role="button"
										data-bs-toggle="dropdown" aria-expanded="false">
										<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-tools me-1" viewBox="0 0 16 16">
